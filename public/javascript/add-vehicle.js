async function addVehicle(event) {
    ...
    const mileage = document.querySelector('input[name="purchase-mileage"]').value.trim();
    const vin = document.querySelector('input[name="vin"]').value.trim();
    const license_plate = document.querySelector('input[name="license-plate"]').value.trim();
    const toll_tag = document.querySelector('input[name="tolltag-number"]').value.trim();
    const registration_expiration = document.querySelector('input[name="registration-expiration"]').value.trim();
